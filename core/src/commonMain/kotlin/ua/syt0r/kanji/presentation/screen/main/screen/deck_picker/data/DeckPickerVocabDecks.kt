...
val DeckPickerVocabCategories: List<DeckPickerCategory> = listOf(
    DeckPickerCategory(
        title = { "Other" },
        description = {
        ...
        items = hardcodedVocabDecks.map {
            DeckPickerDeck(
                previewText = "",
                title = it.titleResolver,
                classification = ua.syt0r.kanji.core.japanese.CharacterClassification.Kana.Hiragana
            )
        }
    )
)
...
private val hardcodedVocabDecks
    get() = listOf(
        HardcodedVocabDeck(
